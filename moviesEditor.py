import flet as ft
from helper import fetch_all, fetch_one, execute_query, check_and_create_db as create_db
...
class MovieApp(ft.UserControl):
    ...
    def build(self):
        ...
        self.movie_list = ft.ListView(expand=True, on_change=self.select_movie)
    ...
    def load_movies(self):
        ...
        self.movie_list.controls = [ft.TextButton(text=movie[1], on_click=lambda e, movie_id=movie[0]: self.select_movie(movie_id)) for movie in movies]
        self.update()
    ...
    def get_selected_movie_id(self):
        # Implement logic to get the selected movie ID from the list
        pass
